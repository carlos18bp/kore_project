    ...
    def get(self, request, customer_id):
        ...
        return Response({
            ...
            'profile': {
                ...
                'date_of_birth': str(cp.date_of_birth) if cp and cp.date_of_birth else None,
                'eps': cp.eps if cp else '',
                'id_type': cp.id_type if cp else '',
                'id_number': cp.id_number if cp else '',
                'id_expedition_date': str(cp.id_expedition_date) if cp and cp.id_expedition_date else None,
