...
description: "Initialize or refresh Kore Project memory-bank files when the user asks for it or when verified repo/runtime guidance has drifted after major changes."
---
