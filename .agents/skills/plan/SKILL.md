---
name: plan
description: "Create a decision-complete implementation plan for a Kore Project change. Use when the user asks to plan, design, scope, or compare approaches before coding."
...
4. Prefer existing Kore Project conventions over generic framework patterns.
