---
name: implement
description: "Implement a Kore Project feature or fix using the repo's existing architecture and minimal targeted verification. Use when the user asks to build, code, or fix something."
