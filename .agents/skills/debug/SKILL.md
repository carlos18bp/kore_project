---
name: debug
description: "Read-only diagnosis workflow for Kore Project bugs, failing flows, or unexpected behavior. Use when the user asks for investigation without applying a fix yet."
