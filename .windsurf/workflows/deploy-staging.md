...
```bash
cd /home/ryzepeck/webapps/kore_project_staging && git fetch origin && git branch -r | grep $BRANCH
```
...
```bash
cd /home/ryzepeck/webapps/kore_project_staging && git fetch origin && git checkout $BRANCH && git pull origin $BRANCH
```
