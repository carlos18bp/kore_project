...
Kore Project uses a **Codex-native repo runtime**. Claude Code is maintained as a compatibility layer only — it must stay aligned with the Codex-native source of truth, not redefine it.
