...
Kore Project migrated from the **Codex plugin/marketplace model** to the **native repo skills model**. The native model is the correct Codex approach: skills live in the repo itself and require no external plugin registry.
...
| `plugins/kore_project-codex/.codex-plugin/plugin.json` | removed |
| `plugins/kore_project-codex/skills/<skill>/SKILL.md` | `.agents/skills/<skill>/SKILL.md` |
...
| Before | After |
|--------|-------|
| `plugins/kore_project-codex/skills/` | `.agents/skills/` |
| `plugins/kore_project-codex/.codex-plugin/` | `.codex/` |
...
| verbose generic SKILL.md content | Kore Project-specific, concise SKILL.md content |
...
|--------|-------|
| `plugins/kore_project-codex/skills/*` | `.agents/skills/*` |
| `Plugin manifest: plugins/kore_project-codex/.codex-plugin/plugin.json` | `Project config: .codex/config.toml` |
