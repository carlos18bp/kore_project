...
const programMeta: ProgramMeta[] = [
  ...
  },
  {
    ...
    description:
      'Un plan diseñado para dos personas que quieren entrenar juntas bajo la misma estructura profesional. Un acceso para ti y uno para tu compañero/a — evaluaciones individuales, sesiones simultáneas y progresión compartida.',
    includes: [
      'Acceso para dos personas',
      'Sesiones simultáneas en el mismo horario',
      'Evaluaciones individuales para cada integrante',
      'Corrección técnica personalizada',
      'Progresión controlada',
    ],
    idealFor: [
      'Parejas o amigos que se motivan entre sí',
      'Quienes buscan entrenar acompañados con supervisión',
      'Mayor adherencia y constancia juntos',
    ],
    image: '/images/pose.webp',
    alt: 'Pose en movimiento — Plan Pareja',
