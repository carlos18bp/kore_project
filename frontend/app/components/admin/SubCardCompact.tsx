...
export default function SubCardCompact({ sub }: { sub: UserSubscriptionEntry }) {
  ...
  return (
    ...
    >
      <div
        className={`w-[42px] h-[42px] rounded-xl bg-gradient-to-br ${tile.gradient} flex items-center justify-center font-heading text-sm text-kore-wine-deep`}
      >
        {tile.icon}
      </div>
      ...
      <span className="text-[11px] font-semibold text-kore-burgundy/65">Ver detalle ›</span>
    </Link>
  );
}
