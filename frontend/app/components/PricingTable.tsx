...
const programMeta: ProgramMeta[] = [
  ...
  },
  {
    ...
    name: 'Pareja FLW',
    shortName: 'Pareja',
    mobileShortName: 'Pareja',
    tagline: 'Entrena en pareja. Progresa juntos.',
    description: 'Un plan para dos personas que entrenan juntas bajo la misma estructura profesional. Evaluaciones individuales, sesiones simultáneas y acceso compartido.',
    includes: [
