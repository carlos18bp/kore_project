...
export default function ForWhom() {
  ...
  return (
    <section ref={sectionRef} className="bg-kore-cream py-16 lg:py-20">
      <div className="w-full px-6 md:px-10 lg:px-16">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          {/* Left - Content */}
          <div className="flex-1 order-2 lg:order-1">
            <span data-animate="fade-up" className="inline-block text-kore-red text-sm font-medium tracking-widest uppercase mb-8">
              Para quién es
            </span>
            <h2 data-animate="split-text" data-delay="0.1" className="text-3xl md:text-4xl lg:text-5xl mb-10 leading-tight">
            ...
            <ul className="space-y-6 mb-12">
              {checkItems.map((item, index) => (
                ...
                >
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-kore-red/10 flex items-center justify-center mt-1">
                    <svg
                      className="w-4 h-4 text-kore-red"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={3}
                  ...
                  <span className="text-base text-kore-gray-dark/80 leading-relaxed">{item}</span>
                </li>
              ))}
            </ul>

            <div data-animate="fade-up" data-delay="0.8" className="flex flex-col sm:flex-row gap-4">
              <a
                href="#programs"
              ...
              <a
                ...
                className="inline-flex items-center justify-center border-2 border-kore-gray-dark/20 text-kore-gray-dark hover:border-kore-red hover:text-kore-red font-medium px-8 py-4 rounded-lg transition-colors duration-200 text-sm tracking-wide gap-2"
              >
          ...
          {/* Right - Image */}
          <div data-animate="fade-right" className="flex-shrink-0 order-1 lg:order-2">
            <div className="relative w-[280px] h-[380px] sm:w-[320px] sm:h-[420px] lg:w-[420px] lg:h-[560px] rounded-3xl overflow-hidden">
              <Image
