...
describe('Programs', () => {
  ...
  it('renders program taglines', () => {
    ...
    expect(screen.getByText('Entrena en pareja. Progresa juntos.')).toBeInTheDocument();
  ...
  it('renders features for each program', () => {
    ...
    expect(screen.getByText('Acceso para dos personas')).toBeInTheDocument();
  ...
  it('renders program images with alt text', () => {
    ...
    expect(screen.getByAltText('Entrenamiento en pareja')).toBeInTheDocument();
